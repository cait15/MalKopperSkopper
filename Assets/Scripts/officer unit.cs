...
{
    [Header("Unit Stats")] public UnitStats stats;
    ...
    [Header("Buffs")] public int temporaryHealthBonus = 0;
    public int temporaryDamageBonus = 0;
    private float buffEndTime = 0f;

    [Header("References")] public SpriteRenderer spriteRenderer;
    public Animator animator;
    public Transform firePoint; // Where projectiles spawn from (for ranged)
    public PlacementSpot placementSpot;

    [Header("Visual Feedback")] public GameObject healthBarPrefab; // health bar stuff
    ...
    void PerformAttack()
    {
       ...
       void ApplyTemporaryHealthBuff(int bonus, float duration)
        {
   ...
   void ApplyTemporaryDamageBuff(int bonus, float duration)
        {
        ...
        void SpawnDogCompanion()
        {
            ...
            // You can assign a dog sprite here if you have one
        ...
        void SetupHealthBar()
        {
            healthBarInstance = Instantiate(healthBarPrefab, transform.position + Vector3.up * 1.5f,
